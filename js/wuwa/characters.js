...
function char(id, name, rarity, weaponType, standard = false, extraWeapon = false){
  return {
    id,
    name,
    rarity,
...
const CHARACTERS = [
  ...
  char("rebecca", "Rebecca", "5★", "pistol", false, true),
